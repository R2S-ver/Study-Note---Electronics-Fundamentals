...
> **注：** 本教程中提供的配图均为英文，因为原版是用英文编写的，在此保留原图暂未做汉化处理。
...
> **⚠️ 关于地区标准的注意事项：** 此处记录的电气安全分析和示例基于我在**荷兰（欧洲）**的本地使用场景。电压标准、配电盘结构、保护机制和安全法规（如 NEN 1010）因国家/地区而异。在进行电气操作时，请务必了解您当地的法规。

</div>

# **目录 (Table of Contents)**
- [家庭用电安全 (Electrical safety at home)](#electrical-safety) <br>
  1\. [简介与项目范围 (Introduction & Project Scope)](#1-introduction--project-scope) <br>
  2\. [家庭电气系统中的保护机制 (Protective Mechanisms)](#2-protective-mechanisms-in-the-household-electrical-system) <br>
  3\. [家庭用电的潜在风险 (Potential Risks)](#3-potential-risks-in-household-power-usage) <br>
  4\. [实践研究 (Practical Research)](#practical-research) <br>
  5\. [参考资料 (References)](#refs-electrical) <br>
...
  1\. [电阻器 (Resistor)](#Resistor) <br>
     &nbsp;&nbsp; 1.1\. 降压 (Voltage Dropping) <br>
     &nbsp;&nbsp; 1.2\. 电压比较器 (Voltage Comparator) <br>
  2\. [电容器 (Capacitor)](#Capacitor) <br>
  3\. [导体 (Conductor)](#Conductor) <br>
     &nbsp;&nbsp; 3.1\. 低通与高通滤波器 (Low-pass and High-pass Filter) <br>
  4\. [二极管 (Diode)](#Diode) <br>
     &nbsp;&nbsp; 4.1\. 整流桥 (Rectifier Bridge) <br>
  5\. [晶体管 (Transistor)](#Transistor) <br>
  6\. [场效应管 (Mosfet)](#Mosfet) <br>
  7\. [线性与开关电源 (Linear and Switching Power Supply)](#Linear-and-Switching-Power-Supply) <br>
     &nbsp;&nbsp; 7.1\. 开关电源分析 (SMPS analysis) <br>
  8\. [实用技能 (Practical skills)](#practical-skills) <br>
  9\. [参考资料 (References)](#refs-components) <br>
----------------------------
...
## 🟪基础电子元器件 (Basic electrical components)
</summary>
      <details><summary>
        
### 🟦电阻器 (Resistor)
...
#### 理论：分压原理 (Theory: Voltage Division Principle)
...
##### LED 可以看作电阻吗？(LED as Resistance?)
LED（发光二极管）不能被当作固定的欧姆电阻，因为它是一个非线性元件。标准电阻器遵循欧姆定律（电流与电压成正比），而 LED 则是具有非线性电流-电压曲线的二极管。

#### 实用电气原理图案例 - 电压比较器 (Pracical electrical schematic case - Voltage Comparator)
...
     <details><summary>
        
### 🟦线性与开关电源 (Linear and Switching Power Supply)
</summary>
...
#### 实用电气原理图案例 - 230V 转 12V 开关电源 (Pracical electrical schematic case - 230V - 12V Switching Power Supply)
